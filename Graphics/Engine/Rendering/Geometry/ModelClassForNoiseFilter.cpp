...
{
	std::array<Engine::Rendering::TexturePtr, 3> textures;
	textures[0] = Engine::Rendering::MakeTexture<Engine::Rendering::DdsTexture>(device, textureFilename1);
	textures[1] = Engine::Rendering::MakeTexture<Engine::Rendering::DdsTexture>(device, textureFilename2);
	textures[2] = Engine::Rendering::MakeTexture<Engine::Rendering::DdsTexture>(device, textureFilename3);
...
{
	return m_textures[0] ? m_textures[0]->GetShaderResourceView() : nullptr;
}


ID3D11ShaderResourceView* ModelClassForNoiseFilter::GetTexture2()
{
	return m_textures[1] ? m_textures[1]->GetShaderResourceView() : nullptr;
}


ID3D11ShaderResourceView* ModelClassForNoiseFilter::GetTexture3()
{
	return m_textures[2] ? m_textures[2]->GetShaderResourceView() : nullptr;
}
