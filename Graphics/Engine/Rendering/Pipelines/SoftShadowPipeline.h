...
namespace Engine::Rendering
{
	...
	private:
		...
		RenderTexturePtr m_shadowTexture;
		RenderTexturePtr m_blackWhiteShadowTexture;
		RenderTexturePtr m_downsampleTexture;
		RenderTexturePtr m_horizontalBlurTexture;
		RenderTexturePtr m_verticalBlurTexture;
		RenderTexturePtr m_upsampleTexture;
