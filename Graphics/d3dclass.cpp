...
=======
	// Î∞∞Î©¥ Ïª¨ÎßÅÏùÑ Ìï¥Ï†úÌïòÎäî ÎûòÏä§ÌÑ∞ Íµ¨Ï°∞Ï≤¥Î•º ÏÑ§Ï†ïÌï©ÎãàÎã§.
	...
	// ÎèÑÎ†§ÎÇ¥ÏßÄ ÏïäÎäî ÎûòÏä§ÌÑ∞ ÎùºÏù¥Ï†Ä ÏÉÅÌÉúÎ•º ÎßåÎì≠ÎãàÎã§.
...
<<<<<<< HEAD
	...
	// ≈ı∏Ì ∞¥√ºøÎ ±Ì¿Ã Ω∫≈ŸΩ« ªÛ≈¬ ª˝º∫ (±Ì¿Ã ≈◊Ω∫∆Æ ON, ±Ì¿Ã æ≤±‚ OFF)
...
>>>>>>> f569692fda4064b72833f8f7de8f4b631805e426
	...
	// Create blend states using helper
	if (!D3DHelpers::CreateBlendState(m_device, &m_alphaEnableBlendingState, TRUE))
	{
		return false;
	}
...
{
	// Î†åÎçî ÌÉÄÍ≤ü Î∑∞ÏôÄ ÍπäÏù¥ Ïä§ÌÖêÏã§ Î≤ÑÌçºÎ•º Ï∂úÎ†• Î†åÎçî ÌååÏù¥ÌîÑ ÎùºÏù∏Ïóê Î∞îÏù∏Îî©Ìï©ÎãàÎã§.
	m_deviceContext->OMSetRenderTargets(1, &m_renderTargetView, m_depthStencilView);
}
...
{
	// Ïª¨ÎßÅ ÎûòÏä§ÌÑ∞ ÎùºÏù¥Ï†Ä ÏÉÅÌÉúÎ•º ÏÑ§Ï†ïÌï©ÎãàÎã§.
	m_deviceContext->RSSetState(m_rasterState);
}
...
{
	// Îí∑Î©¥ ÏóÜÏùå Ïª¨ÎßÅ ÎûòÏä§ÌÑ∞ ÎùºÏù¥Ï†Ä ÏÉÅÌÉúÎ•º ÏÑ§Ï†ïÌï©ÎãàÎã§.
...
{
	// ±Ì¿Ã ≈◊Ω∫∆Æ¥¬ ON, ±Ì¿Ã æ≤±‚¥¬ OFF ªÛ≈¬∑Œ º≥¡§
	// ≈ı∏Ì ∞¥√º(«Æ µÓ)∞° ¡ˆ«¸ø° ¿««ÿ ø√πŸ∏£∞‘ ∞°∑¡¡ˆµµ∑œ «‘
